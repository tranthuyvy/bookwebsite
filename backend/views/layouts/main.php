        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>NHASACHTV</span></a>
                </div>
                ...
                <nav class="nav navbar-nav">
                    <ul class=" navbar-right">
                        <li class="nav-item dropdown open" style="padding-left: 15px;">
                            <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <iframe width="100%" height="400" frameborder="0" id="ifile" src='/bookwebsite/backend/web/filemanager/dialog.php?type=1&field_id=proImg'></iframe>
            </div>
        </div>
    </div>
</div>
